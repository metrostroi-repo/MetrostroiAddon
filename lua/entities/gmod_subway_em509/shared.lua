...
function ENT:InitializeSounds()
    ...
    self.SoundPositions["ezh3_revers_0-f"] = {80,1e9,Vector(457.85,-22.8,-6)}
    ...
    self.SoundPositions["uava_reset"] = {80,1e9,Vector(456.70,56.0,-10.23349),0.6}
    ...
    self.SoundPositions["front_isolation"] = {300,1e9,Vector(469, 0,-63),1}
    self.SoundNames["rear_isolation"] = {loop=true,"subway_trains/common/pneumatic/isolation_leak.wav"}
    self.SoundPositions["rear_isolation"] = {300,1e9,Vector(-473, 0,-63),1}
    ...
    self.SoundPositions["valve_brake"] = {400,1e9,Vector(464.5-0.1,24.4,-50),1}
    ...
    self.SoundPositions["pneumo_TL_open_background"] = {180,1e9,Vector(449.90,-56.47,-33.9),0.2}
    ...
    self.SoundPositions["igla_on"] = {50,1e9,Vector(459.1,-53.7+2,15.81+1),0.1}
    self.SoundPositions["igla_off"] = {50,1e9,Vector(459.1,-53.7+2,15.81+1),0.1}
    self.SoundPositions["igla_start1"] = {50,1e9,Vector(459.1,-53.7+2,15.81+1),0.1}
    self.SoundPositions["igla_start2"] = {50,1e9,Vector(459.1,-53.7+2,15.81+1),0.1}
    ...
    self.SoundPositions["horn"] = {1100,1e9,Vector(475,-20,-55)}
    ...
    self.SoundPositions["kv70_fix_on"] =    {100,1e9,Vector(457.85,-22.8,-6),1}
    self.SoundPositions["kv70_fix_off"] =   self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_0_t1"] =      self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv70_t1_0_fix"] =  self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_t1_0"] =      self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_t1_t1a"] =    self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_t1a_t1"] =    self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_t1a_t2"] =    self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_t2_t1a"] =    self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_0_x1"] =      self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_x1_0"] =      self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_x1_x2"] =     self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_x2_x1"] =     self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_x2_x3"] =     self.SoundPositions["kv70_fix_on"]
    self.SoundPositions["kv40_x3_x2"] =     self.SoundPositions["kv70_fix_on"]
    ...
    self.SoundPositions["vpr"] = {50,1e9,Vector(403,-38.2 ,55),0.05}
    ...
    self.SoundPositions["parking_brake_rolling"] = {65,1e9,Vector(456.72,35.5,-14.843545),0.1}
