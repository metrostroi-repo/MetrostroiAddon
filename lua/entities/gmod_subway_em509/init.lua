...
function ENT:Initialize()
    ...
    self.KeyMap = {
        ...
        [KEY_MINUS] = {helper="R_Program2HSet"},
...
function ENT:Think()
    ...
    self:SetPackedRatio("BLPressure", Pneumatic.ReservoirPressure/12)
    self:SetPackedRatio("TLPressure", Pneumatic.TrainLinePressure/12)
