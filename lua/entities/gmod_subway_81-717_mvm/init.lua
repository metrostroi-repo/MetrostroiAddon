...
----------------------------------*****************************--------------------------------
    ...
    --local _a = 25*(#self.WagonList - #self.WagonList/(#self.WagonList-0.99))                             --0.99 instead of 1 is for zero division protection
    ...
    --print("self.WagonNumber = "..self.WagonNumber)
----------------------------------*****************************--------------------------------
