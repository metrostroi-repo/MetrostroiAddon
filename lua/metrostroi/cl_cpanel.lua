...
local function ClientPanel(panel)
    ...
    panel:NumSlider(Metrostroi.GetPhrase("Panel.HoverTextDelay"),"metrostroi_tooltip_delay",0,5)
    panel:NumSlider(Metrostroi.GetPhrase("Panel.CrosshairHideDelay"),"metrostroi_crosshair_delay",1,10)
