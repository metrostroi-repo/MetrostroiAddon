...
function TRAIN_SYSTEM:Initialize()
    ...
    self.Train:LoadSystem("KSD_VAU","Relay")
...
if CLIENT then
    ...
    local function State5(Train)
        ...
        local Vd = Train:GetNW2Int("PAM:Vd")
        ...
        draw.SimpleText("28.08.2012","Metrostroi_PAM24",57,11, Color(199,199,199),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
        draw.SimpleText("12:38:19","Metrostroi_PAM28",59,32, Color(199,199,199),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
        ...
        --Линия
        draw.SimpleText(Train:GetNW2String("PAM:Line"),"Metrostroi_PAM28",239,13, Color(222,234,58),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
        --Путь
        draw.SimpleText(Train:GetNW2String("PAM:Path"),"Metrostroi_PAM28",371,13, Color(222,234,58),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
        ...
        elseif Vd == 0 then
            ...
            Metrostroi.DrawLine(6,68,6,107,Color(246,242,0),3)
        elseif Vd <= 20 then
            draw.SimpleText(0,"Metrostroi_PAM24",-4+5.47*20,122, Color(232,13,12),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
            Metrostroi.DrawLine(-5+5.47*20,68,-5+5.47*20,107,Color(246,242,0),3)
        else
            draw.SimpleText(speedLimit,"Metrostroi_PAM24",-4+5.47*speedLimit,122, Color(246,242,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
            Metrostroi.DrawLine(-5+5.47*speedLimit,68,-5+5.47*speedLimit,107,Color(246,242,0),3)
        end
        ...
        elseif mode == 4 or mode == 5 then
            ...
            draw.SimpleText("Уклон=","Metrostroi_PAM28",349,411, Color(27,234,30),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
            draw.SimpleText("S=1337.00м","Metrostroi_PAM31",639,412, Color(27,234,30),TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER)
        ...
        Metrostroi.DrawLine(4,173+14,15,173+14,Color(206,206,206),3)
        ...
        Metrostroi.DrawLine(570,262+14+1,583,262+14+1,Color(206,206,206),3)
        ...
        for i=block and 1 or 0,0,-1 do
            ...
            Metrostroi.DrawLine(3,218+14+i,15,218+14+i,((driveMode==2 or driveMode==4) and i==0) and Color(85,75,225) or blocked and Color(140,140,140) or Color(206,206,206),3)
            if ksd then
                ...
                Metrostroi.DrawLine(3,264+14+i,15,264+14+i,((driveMode==1 or driveMode==5) and i==0) and Color(85,75,225) or blocked and Color(140,140,140) or Color(206,206,206),3)
            end
            ...
            Metrostroi.DrawLine(3,304+14+i,17,304+14+i,blocked and Color(140,140,140) or Color(206,206,206),3)
            ...
            Metrostroi.DrawLine(570,170+14+i,583,170+14+i,blocked and Color(140,140,140) or Color(206,206,206),3)
            ...
            Metrostroi.DrawLine(570,216+14+i,583,216+14+i,(Train:GetNW2Bool("PAM:State5_-6") and i==0) and Color(85,75,225) or blocked and Color(140,140,140) or Color(206,206,206),3)
            ...
            --Metrostroi.DrawLine(570,262+14+i,583,262+14+i,blocked and Color(140,140,140) or Color(206,206,206),3)
            ...
            Metrostroi.DrawLine(570,308+14+i,583,308+14+i,blocked and Color(140,140,140) or Color(206,206,206),3)
            ...
            Metrostroi.DrawLine(570,354+14+i,583,354+14+i,(mode == 3 and i==0) and Color(85,75,225) or blocked and Color(140,140,140) or Color(206,206,206),3)
        end
        if state==0 then
            surface.SetDrawColor(192,192,192,255)
            surface.DrawRect(0,119,636,248,0)
            for i,text in pairs(menus) do
                local color = i==3 and Color(113,113,113) or i==sel and Color(255,255,255) or Color(0,0,0)
...
function TRAIN_SYSTEM:TriggerInput(name,value)
    if name == "KSDMode" then self.PAKSD = value>0 end
end
...
function TRAIN_SYSTEM:Trigger(name,value,press)
    ...
    if self.State == 1 and not value then
        if name == "Esc" then
            self.State = 1.5
            self:SetWaitTimer(0.1)
        end
        if name == "Enter" and self.GoodSetup and self.ReverserWrench then
            self.State = 2
            self:SetWaitTimer(0.1)
            self.Selected = 1

            self.LineS = self.LineS or self.Line
            self.PathS = self.PathS or self.Path
            self.StationS = self.StationS or self.Station
            self.RouteNumberS = self.RouteNumberS or self.RouteNumber
            self.DriverNumberS = self.DriverNumberS or self.DriverNumber

            self.HaveRestart =  #self.DriverNumber == 4 and #self.RouteNumber == 3
                and Metrostroi.PAMConfTest[self.Line]
                and Metrostroi.PAMConfTest[self.Line][tonumber(self.Path)]
                and Metrostroi.PAMStations[self.Line][tonumber(self.Station)]
            Train:SetNW2Bool("PAM:HaveRestart",self.HaveRestart)
        end
    ...
    elseif self.State == 2 then
        ...
        if (name == "Esc" or name == "Enter") and not value and self.Selected == 3 then
            self.State = 1
            self:SetWaitTimer(0.1)
        end
        if (name == "1" or name == "Enter") and not value and self.Selected == 1 then
            self.State = 3
        ...
        if self.HaveRestart and (name == "2" or name == "Enter") and not value and self.Selected == 2 then
            self.State = 3.5
            self.KeyboardX,self.KeyboardY = 22,47
            self:SetWaitTimer(0.1)
            self.Selected = 1
            self.StationS = tostring(self.StationS)
            self.PathS = tostring(self.PathS)
            self.RouteNumberS = tostring(self.RouteNumberS)
            self.DriverNumberS = tostring(self.DriverNumberS)
            Train:SetNW2String("PAM:EnterError","")
        end
        if (name == "M" or name == "Enter") and not value and self.Selected == 4 then
            self.State = 2
            self:SetWaitTimer(0.1)
        end
    elseif self.State == 3 then
        ...
        if name == "Left" and value then
            ...
            if self.Selected == 2 then self.PathS = self.Path:sub(1,-2) end
    ...
    elseif self.State == 3.5 then
        ...
        if name == "Enter" and not value then
            if #self.StationS < 3 or not Metrostroi.PAMStations[self.LineS] or not Metrostroi.PAMStations[self.LineS][tonumber(self.StationS)] then
                Train:SetNW2String("PAM:EnterError","Неверный номер станции")
            elseif #self.Path < #tostring(Metrostroi.LineCount) or not Metrostroi.PAMConfTest[self.Line][tonumber(self.PathS)] then
                Train:SetNW2String("PAM:EnterError","Неверный номер пути")
            else
                self.Station = self.StationS
                self.Path = self.PathS
    ...
    elseif self.State == 4 and not self.CheckRing and not self.Stopping and name == "Enter" and not value then
        self.State = 5
        self.EPKActive = 1
        self.ControlMode = 2
        self:SetWaitTimer(0.1)
    ...
    elseif self.State == 5 then
        ...
        if self.State5Accept then
            ...
            if name == "Enter" and not value then
                ...
                elseif self.State5Accept == -6 then
                    ...
                    if self.StationTable and self.StationTable~=prev and self.Speed<0.2 then
                        self.FireBack = prev
                        self:Message(16)
                    else
                        self.FireBack = false
                ...
                elseif self.State5Accept == -3 then
                    ...
                    self:Message(20)
                elseif self.State5Accept == -4 then
                    if self.Speed<0.2 and (self.StationTable.isLast or self.StationTable.hasSwitches) then
                        self:Message(5)
                        self.Shunt = true
                    else
                        self:Message(3)
        ...
        elseif self.State5 == 0 then
            if char and value and char ~= 3 then self.Selected = char end
        ...
        elseif self.State5 == 9 then
            ...
            if name == "3" and value then self.State5Accept=-3 end
...
function TRAIN_SYSTEM:CANReceive(source,sourceid,target,targetid,textdata,numdata)
    ...
    elseif textdata == "Answer" then
        ...
        if back and back.RR and self.State>0 then
            ...
            if self.State<5 and back.State>=5 then self.EPKActive = 1 self.State = 5 self.ControlMode = 2 end
            if self.State==5 then
                ...
                if back.Mode<=4 and not self.Deadlock then
                    self.Mode = math.min(2,back.Mode)
                --[[ elseif back.Mode==3 and self.StationTable and self.StationTable.isInWrong and self.Deadlock then
                    self.Mode = 2
                    self.Deadlock = nil--]]
                end
                if (back.Mode==5 or back.Mode==1) and self.Mode~=1 then
                    self.Mode = 1
                    self.Distance = 1000
                    self.StationTable,self.PrevStationTable = self:FindStation(self.Line,self.Path,self.Station)
                    self.LastStationTable = self:FindLastStation()
...
function TRAIN_SYSTEM:Think(dT)
    ...
    if self.State > 0 then
        self.GoodSetup = Metrostroi.PAMConfTest ~= nil
        ...
        if self.State == 4 then
            ...
            if RR and PAM_VV.KDL > 0 or PAM_VV.KDP > 0 then
                self:SetDoorMode(PAM_VV.KDP>0 and "DP"or "DL")
            else
                self:SetDoorMode("DO")
            end
            if RR and speed>0.2 then self.Stopping = true end
            if RR and speed<=0.2 and PAM_VV.KGR>0 and PAM_VV.KB>0 then self.Stopping = false end
            if RR and self.Stopping then
        ...
        if self.State == 5 then
            ...
            --Distance count
            if not self.Distance then self.Distance = self.StationTable and self.StationTable.pos or 0 end
            if self.Mode > 1 and self.Mode~=6 then
            ...
            if RR and (self.Mode==2 or self.Mode==3) and (dist < -3 and (self.Transit or not self.AntiMiss)) or self.OpenControl == false and speed > 0.2  or self.Mode == 4 and dist<0 then
                ...
                elseif oldSt and oldSt.isLast and oldSt.dist_last_end then
                    ...
                    self.Mode = 1
                    self.StationTable = self:FindFirstStation()
                end
            ...
            if self.Mode==2 and dist<=200 then
                ...
                elseif self.StationBrakeRing and CurTime()-self.StationBrakeRing>0.05 then self.StationBrakeRing = false end
            elseif self.StationBrakeRing==false or self.StationBrakeRing and CurTime()-self.StationBrakeRing > 0.05 then
                self.StationBrakeRing = nil
            end

            Train:SetNW2Int("PAM:Mode",self.Mode)
            self:Error(8,self.AntiMiss==2 or dist<-3 and self.AntiMiss )
            ...
            --TODO: При наличии 16 провода и отсутвии 15го в течении 5 секунд подсказка "Нет контроля закрытия дверей"
            local CanOpen = PAM_VV.KRH==0 and (PAM_VV.LPT > 0 or self.NoLPT and PAM_VV.V1>0)
            if RR and ((opv or self.Mode==5) and speed < 0.5 or (self.OpenDoors and speed < 2.5)) and CanOpen then
                self:SetDoorMode(not self.OpenControl and "ZD" or "DO")
                local err
                if (self.Mode > 3 or self.OpenDoors) then
                ...
                elseif self.Mode<=3 then
                    ...
                    if PAM_VV.ZD==0 and CanOpen then
                        ...
                        if opv and (stationTable==self.StationTable or self.FireBack) then
                            ...
                            self.FireBack = false
                            if not self.AntiMiss then self.AntiMiss = false end
                        end
                        if not self.OpenControl then self.OpenControl = CurTime() end
                        if not self.OpeningTimer and PAM_VV.KD>0 then self.OpeningTimer = CurTime() end
                    else
                ...
                if RR and (not CanOpen or PAM_VV.ZD>0 or self.DoorMode=="ZD") then self:SetDoorMode("ZD") end
                self.OpenDoors = false
            ...
            if RR and (self.OpenControl~=true or PAM_VV.K16>0) and PAM_VV.KD==0 then
            ...
            elseif self.KDTimer then
                self.KDTimer = nil
            end
            if RR and self.OpenControl and  self.StationTable.isHorlift and self.SpeedLimit~=0 then
                if not self.StationDoorsTimer then self.StationDoorsTimer = CurTime() end
                if PAM_VV.KB>0 then self.StationDoorsTimer = true end
            elseif self.StationDoorsTimer then
            ...
            self:Error(27,self.StationDoorsTimer and self.StationDoorsTimer~=true and CurTime()-self.StationDoorsTimer>1.5)
            ...
            if self.NoKD then self:SetDoorMode("ZD") end
            ...
            if RR and PAM_VV.I33*PAM_VV.LPT>0 and not self.NoLPT then
                if not self.LPTTimer then self.LPTTimer = CurTime() end
            elseif self.LPTTimer and (PAM_VV.KGR>0 or not RR or self.NoLPT or CurTime()-self.LPTTimer<=6.5) then
                self.LPTTimer = nil
            end
            ...
            local BlockBack = not self.FireBack and (not self.StationTable.isHorlift or dist > -.45 or dist < -6 or speed>=3.6)
            ...
            local speedLimit = math.max(20,self.SpeedLimit+1)
            if self.ControlMode == 1 then
                speedLimit =  (speedLimit > 40 and 35 or 20)*PAM_VV.KB
            elseif PAM_VV.KB>0 then
                speedLimit=20
            end
            if self.Mode > 3 then speedLimit =  math.min(40,speedLimit) end
            local OXT = false
            --KS Mode
            if RR and self.SpeedLimit <= 20 then
                ...
                if self.ZeroStopped and PAM_VV.KB == 0 or self.SpeedLimit~=-1 and ((ALS.F6==0 or station and self.Transit) and not self.Vd0 and (PAM_VV.VRD==0 or self.PAKSD) and not station) then
                    self:SetDriveMode("OXT")
                    OXT = true
                    speedLimit=0
                end
                ...
                self:Error(12,not self.ZeroStopped and PAM_VV.KGR==0 and OXT and PAM_VV.KB>0)
                self:Error(15,self.ZeroTimer and CurTime()-self.ZeroTimer>30,7,true)
            elseif self.SpeedLimit > 20 then
            ...
            if RR and (speedMpS+self.Acceleration*timeAdd > speedLimitMpS and speed>0.2 or self.STTimer) then
            ...
            if RR and self.Transit and self.Mode == 2 then
                local lasttbl = self.Deadlock or self.LastStationTable
                local last = lasttbl and lasttbl.id==self.StationTable.id
                if last and dist<60 and speed>10 or not last and dist<50 and speed>35 then
                    self.TransitBraking = last and 10 or 35
                end
                if self.TransitBraking and speed>self.TransitBraking then
                    self:SetDriveMode("AT")
            ...
            if RR and not self.Transit and (self.Mode==2 or self.Mode==3) then
                if self.AntiMiss == nil then
                    ...
                    if speed>0.2 and (dist-SchemeEngageDistance) < (speedMpS^2)/_ACCEL2 and not self.AntiMiss then
            ...
            Ring = self.RingArmed or self.BoardRing or self.StationBrakeRing or errorsRing[self.CurrentError] or self.CurrentErrorRing and CurTime()-self.CurrentErrorRing<1.5
            ...
            Train:SetNW2Int("PAM:Vd",self.SpeedLimit)
            ...
            Train:SetNW2Bool("PAM:State5_8",self.Deadlock~=nil) --ОБ
        ...
        self.EPK = (self.State==4 or self.State==5 and RR and self.EPKActive) and 1 or 0
    ...
    Train:SetNW2Bool("PAM:KSD",self.PAKSD)
    --[[
    local pos = Metrostroi.TrainPositions[Train];pos = pos and pos[1]
    self.Distance2 = self.Distance2 or self.Distance
    local delta = 0
    if pos then
        local x = pos.x+Train.PosX
        self.Distance = self.Distance or x
        self.OldPos = self.OldPos or x
        delta = x-self.OldPos
        self.OldPos = x
    end
    self:FindNextSignal()
    self:FindNextStation()
    local speed = Train.Speed*Train.SpeedSign
    local speedMpS = speed*0.2778
    if not self.Distance then return end
    self.Distance = self.Distance + delta
    self.Distance2 = self.Distance2 + speedMpS*dT
    Train:SetNW2Float("PAM:TrackS",pos and pos.x+Train.PosX or -2)
    Train:SetNW2Float("PAM:S",self.Distance)
    Train:SetNW2Float("PAM:Sd",delta)
    Train:SetNW2Float("PAM:S2",self.Distance2)
    Train:SetNW2Float("PAM:S2d",delta)
    if IsValid(self.Signal) then
        Train:SetNW2String("PAM:Signal",self.Signal.Name)
    end
    if self.Station then
        Train:SetNW2Int("PAM:Station",self.Station[1])
        Train:SetNW2Int("PAM:StationD",self.Station[2])
        Train:SetNW2Float("PAM:StationS",self.Station[2]-self.Distance)
    end--]]
end