...
Spawner.Preset.New                      = Utwórz nowy
Spawner.Preset.Unsaved                  = Zapisz bieżący
Spawner.Preset.NewTooltip               = Utwórz
Spawner.Preset.UpdateTooltip            = Update
Spawner.Preset.RemoveTooltip            = Usuń
Spawner.Presets.NamePlaceholder         = nazwa presetu
Spawner.Presets.Name                    = Tytuł
Spawner.Presets.NameError               = błąd tytułu
Spawner.Preset.NotSelected              = nie wybrano ustawienia wstępnego
