...
#######Buttons###########
#Common
Common.502.KS                   = KSAUP mushaobs
Common.502.AV                   = ATO/avTo martvis rezhimi chartuLia
Common.502.SD                   = SD: karis mdgomareobis machvenebeLi (karebebi daxuruLia)
Common.502.SDW                  = SD: karis mdgomareobis machvenebeLi (karebebi ghiaa)
Common.502.L3w                  = natura 3 (X3)
Common.502.L4w                  = natura 4 (ukan mimartuLebit modzraoba)
Common.502.L5w                  = natura 5 (win mimartuLebit modzraoba)
Common.502.L16w                 = natura 16 (karebebis sakeTi)
Common.502.L20w                 = natura 20 (LK2 da LK5 daxurva)
Common.502.L23w                 = natura 23 (kompresoris konTroLi)
Common.502.RK1                  = pirveLi RK poziciis konTroLi
Common.502.BRD                  = karebebi gafuchebuLia
Common.502.KOS                  = KB: sichqaris LimiTis ghiLaki (sifxizLis ghiLaki)
Common.502.VAK                  = AK: awyoba avariuLi martvis sqemebis
Common.502.LRU                  = avariuLi martvis sqemebi aqTiuria

#Spawner
Spawner.502.TypeNVL         = maTarebeLi NVLdan
Spawner.502.TypeKVLO        = dzveLi maTarebeLi KVLdan
Spawner.502.TypeKVLN        = axaLi maTarebeLi KVLdan
Spawner.502.EWagons         = "E" Tipis vagonebis damaTeba

#gmod_subway_81-502
Entities.gmod_subway_81-502.Buttons.VBA.VBAToggle = ATO baTareis chartva

Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: avariuLi martvis rezhimi
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: pneumaTiuri konTroLeris gamomrtveLis gamortva
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: karis sakeTis konTroLis gamortva
...
Entities.gmod_subway_81-502.Buttons.RCAV3.RCAV3Toggle           = KSAUP sqemis gawyveTa (AV3)
Entities.gmod_subway_81-502.Buttons.RCAV4.RCAV4Toggle           = KSAUP sqemis gawyveTa (AV4)
Entities.gmod_subway_81-502.Buttons.RCAV5.RCAV5Toggle           = KSAUP sqemis gawyveTa (AV5)
