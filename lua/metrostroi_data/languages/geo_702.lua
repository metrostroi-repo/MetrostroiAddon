...
#Cameras:
Train.702.Breakers1 = baTareis chamrtveLi
Train.702.Breakers2 = ganatebis chamrtveLi
Train.702.Breakers3 = mtavari gamtishveLi
Train.703.Breakers1 = baTareis chamrtveLi
Train.703.Breakers2 = mtavari gamtishveLi da baTareis chamrtveLi
Train.703.Parking   = parkingis muxruchi, UAVA
Train.703.RCARS     = RC-1: ARS sqemis gamwyveTi
Train.703.AVU       = AVU bLoki

#Spawner
Spawner.707.Type    = paneLis Tipi
Spawner.707.Type1   = dzveLi + RRI
Spawner.707.Type2   = axaLi + ASNP
Spawner.710.RRI     = radio reLei informaTori

#######Buttons###########
Train.Buttons.ParkingBrake      = %d%%
Train.Buttons.EnginesVoltage    = %d V #NEW (volts)
Train.Buttons.CanAB             = avTobLokis rezhimis chartva shesadzLebeLia #NEW (signaLebis avTomaTuri dabLokva (ARS gareshe))
Train.Buttons.InAB              = avTobLokis rezhimshi #NEW (signaLebis avTomaTuri dabLokva (ARS gareshe))

#Common
Common.702.VZ1                  = pneumaTuri sarqveLi №1
Common.703.ParkingBrakeLeft     = parkingis muxruchis ashveba
Common.703.ParkingBrakeRight    = parkingis muxruchis momaTeba
Common.703.KSD                  = KSD: karebis sakeTis martvis ghiLaki
Common.703.SD                   = @[Common.502.SDW]
Common.703.VU1                  = memanqanis gamatbobeLi
Common.703.VU2                  = avariuLi ganateba
Common.703.VU3                  = memanqanis kabinis ganateba
Common.703.AV                   = mtavari gamomrtveLi (maghaLi dzabvis sqemebi)
Common.703.LOn                  = ganatebis chartva
Common.703.LOff                 = ganatebis gamortva
Common.703.KRR                  = KRR: RK daTriaLeba pirveL poziciaze #FIXME
Common.703.RUT                  = RUT reguLireba (shemcirebuLi achqareba)
Common.707.SEQ                  = reosTaTis konTroLeris modzraobis natura
Common.707.TAH                  = TAH: avariuLi martvis rezhimi ARSis gareshe samartavad
Common.710.LKVT                 = sifxizLis natura #NEW #FIXME

Common.710.SAMMSchemeOff        = SAMM gamortvis ghiLaki
Common.710.SAMMStart            = SAMM chartvis ghiLaki
Common.710.SAMMReset            = SAMM: gadayenebis ghiLaki
Common.710.SAMMXTLamp           = SAMM: martvis/muxruchis sqemebis awyoba ATO
Common.710.SAMMSignal1          = SAMM: @[Common.ALL.Unsused1]
Common.710.SAMMSignal2          = SAMM: @[Common.ALL.Unsused1]
Common.710.SAMMOn               = SAMM: chartva
Common.710.SAMMUnit             = SAMM: shemsruLebeLi bLoki
Common.710.SAMMX2               = SAMM: X2 rezhimi
Common.710.SAMMAhead            = SAMM: dawevis rezhimi
Common.710.SAMMAccept           = SAMM: ufLeba
...
Entities.gmod_subway_ezh.Buttons.Main1.1:ALSFreqToggle  = @[Common.ARS.Freq]
...
Entities.gmod_subway_ezh.Buttons.Main2.2:ALSFreqToggle  = @[Common.ARS.Freq]
