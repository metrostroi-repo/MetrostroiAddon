...
#######Buttons###########
#Common
Common.502.KS                   = KSAUP im Betrieb
Common.502.AV                   = Autonomes fahren ist aktiv
Common.502.SD                   = SD: Türfreigabe (Türen sind geschlossen)
Common.502.SDW                  = SD: Türfreigabe (Türen sind geöffnet)
Common.502.L3w                  = 3. Lampe (X3 Modus)
Common.502.L4w                  = 4. Lampe (Rückwärts)
Common.502.L5w                  = 5. Lampe(Vorwärts)
Common.502.L16w                 = 16. (Türverriegelung)
Common.502.L20w                 = 20. (LK2 und LK5 schließung)
Common.502.L23w                 = 23r. (Steuerung des Luftpressers)
Common.502.RK1                  = Steuerung der ersten Schaltwerkposition
Common.502.BRD                  = Türstörung
Common.502.KOS                  = KB: Wachsamkeitstaste
Common.502.VAK                  = AK: Stromkreise für Notfahrmodus schließen
Common.502.LRU                  = Notfahrmodus aktiv
#Spawner
Spawner.502.TypeNVL         = Zugtyp NVL
Spawner.502.TypeKVLO        = altes KVL Triebfahrzeug
Spawner.502.TypeKVLN        = neues KVL Triebfahrzeug
Spawner.502.EWagons         = "E" Wagen einsetzen
#gmod_subway_81-502
Entities.gmod_subway_81-502.Buttons.VBA.VBAToggle = Batterie für autonomes Fahren an/aus
Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: Sperrfahrt
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: Deaktiviren von pneumatischer Steuerungs Überbrückung
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: Türverriegelung ausschalten
...
Entities.gmod_subway_81-502.Buttons.RCAV3.RCAV3Toggle           = KSAUP Lasttrennschalter (AV3)
Entities.gmod_subway_81-502.Buttons.RCAV4.RCAV4Toggle           = KSAUP Lasttrennschalter (AV4)
Entities.gmod_subway_81-502.Buttons.RCAV5.RCAV5Toggle           = KSAUP Lasttrennschalter (AV5)
