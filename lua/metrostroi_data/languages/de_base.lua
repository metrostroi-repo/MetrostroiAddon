...
Workshop.NotInstalledE      = Nicht installiert.Abboniere das Addon und ueberpruefe es im "Addons" menue.
Workshop.NotInstalled       = Nicht installiert.
Workshop.Disabled           = Deaktiviert. Aktiviere es im "Addons" menue.
...
Workshop.ErrorEnhancers     = Dieses Addon enthält Grafikverbesserer, die das komfortable Spiel beeinträchtigen können.
...
Panel.SoftDraw          = Element "weiches Laden" in Prozent
...
Train.Common.PneumoPanels   = Ventile
Train.Common.Voltmeters     = Voltmeter and amperemeter
Train.Common.CouplerCamera  = Kupplung
...
Entities.gmod_subway_81-717_mvm_custom.Name     = 81-717 (Moscow Benutzerdefiniert)
...
Entities.gmod_train_special_box.Name        = Speziallieferung

#Weapons
Weapons.button_presser.Name                 = Knopfdrücker
Weapons.button_presser.Purpose              = Wird zum Bedienen von Knöpfen auf Maps genutzt.
Weapons.button_presser.Instructions         = Zum bedienen linke Maustaste drücken.
Weapons.train_key.Name                      = Administratorschlüssel
Weapons.train_key.Purpose                   = Wird zum bedienen von Adminknöpfen benutzt.
Weapons.train_key.Instructions              = Zum bedienen linke Maustaste drücken.
Weapons.train_kv_wrench.Name                = Richtungswender
Weapons.train_kv_wrench.Purpose             = Wird zum bedienen von Knöpfen in Zügen verwendet.
Weapons.train_kv_wrench.Instructions        = Zum bedienen linke Maustaste verwenden.
Weapons.train_kv_wrench_gold.Name           = goldener Richtungswender
...
#Spawner common
Spawner.Title                           = Zugspawner
Spawner.Spawn                           = Spawnen
Spawner.Close                           = Schließen
Spawner.Trains1                         = erlaubte Wagen
Spawner.Trains2                         = pro Spieler
Spawner.WagNum                          = Anzahl der Wagen
Spawner.PresetTitle                     = Presets
Spawner.Preset.New                      = Neu erstellen
Spawner.Preset.Unsaved                  = Aktuell speichern
Spawner.Preset.NewTooltip               = Erstellen
Spawner.Preset.UpdateTooltip            = Aktualisieren
Spawner.Preset.RemoveTooltip            = Entfernen
Spawner.Presets.NamePlaceholder         = Name des Presets
Spawner.Presets.Name                    = Name
Spawner.Presets.NameError               = Name fehlgeschlagen
Spawner.Preset.NotSelected              = Kein Preset ausgewählt
...
Common.Spawner.SpawnMode                = Zugstatus
Common.Spawner.SpawnMode.Deadlock       = kalt
Common.Spawner.SpawnMode.Full           = voll gestartet
Common.Spawner.SpawnMode.NightDeadlock  = kalt über Nacht
Common.Spawner.SpawnMode.Depot          = Depot
Spawner.Common.EType                    = Art der Stromkreise
Common.Spawner.Scheme                   = Linienplan
Common.Spawner.Random                   = züfällig
Common.Spawner.Old                      = alt
Common.Spawner.New                      = neu
Common.Spawner.Type                     = Typ
Common.Spawner.SchemeInvert             = Linienplan umdrehen

#Coupler common
Common.Couple.Title         = Kupplungsmenü
Common.Couple.CoupleState   = Kupplungsstatus
Common.Couple.Coupled       = gekuppelt
Common.Couple.Uncoupled     = nicht gekuppelt
Common.Couple.Uncouple      = entkuppeln
Common.Couple.IsolState     = Absperrhähne
Common.Couple.Isolated      = geschlossen
Common.Couple.Opened        = offen
Common.Couple.Open          = öffnen
Common.Couple.Isolate       = schließen
Common.Couple.EKKState      = EKK Status
Common.Couple.Disconnected  = getrennt
Common.Couple.Connected     = verbunden
Common.Couple.Connect       = verbinden
Common.Couple.Disconnect    = trennen

#Bogey common
Common.Bogey.Title              = Drehgestellmenü
Common.Bogey.ContactState       = Status der Stromabnehmer
Common.Bogey.CReleased          = gelöst
Common.Bogey.CPressed           = angelegt
Common.Bogey.CPress             = anlegen
Common.Bogey.CRelease           = lösen
Common.Bogey.ParkingBrakeState  = Handbremsstatus
Common.Bogey.PBDisabled         = manuell ausgeschalten
Common.Bogey.PBEnabled          = An
Common.Bogey.PBEnable           = Aus #FIXME
Common.Bogey.PBDisable          = Manuell Aus #FIXME

#Trains common
Common.ALL.Unsused1                         = Nicht im Gebrauch
Common.ALL.Unsused2                         = (nicht im Gebrauch)
Common.ALL.Up                               = (hoch)
Common.ALL.Down                             = (runter)
Common.ALL.Left                             = (links)
Common.ALL.Right                            = (rechts)
Common.ALL.CW                               = (im Uhrzeigersinn)
Common.ALL.CCW                              = (gegen den Uhrzeigersinn
...
Common.ALL.EmergencyBrakeValve              = Notbremse
Common.ALL.ParkingBrake                     = Handbremse
...
Common.ALL.EPK                              = ARS Elektropneumatisches Ventil (EPK)
Common.ALL.EPV                              = ARS Elektropneumatisches Ventil (EPV)
...
Common.ARS.VP                               = Hilfstriebfahrzeug
...
Common.ALL.DriverValveBLDisconnect          = Absperrhahn fuer Hauptluftleitung
Common.ALL.DriverValveTLDisconnect          = Absperrhahn fuer Hauptluftbehälter
...
Common.ALL.FrontBrakeLineIsolationToggle    = Absperrhahn fuer Hauptluftleitung
Common.ALL.FrontTrainLineIsolationToggle    = Absperrhahn fuer Hauptluftbehälter
Common.ALL.RearTrainLineIsolationToggle     = Absperrhahn fuer Hauptluftbehälter
Common.ALL.RearBrakeLineIsolationToggle     = Absperrhahn fuer Hauptluftleitung
Common.ALL.UAVA                             = UAVA: Uberbrueckung von Zwangsbremsungen von Signalen(kann reaktiviert werden wenn der Druck der Hauptluftleitung abfaellt)
...
Common.ALL.BLTLPressure     = Druck in den Leitungen (rot: Hauptluftleitung, schwarz: Hauptluftleitung)
