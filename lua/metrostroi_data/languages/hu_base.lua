...
Spawner.Preset.New                      = hozzon létre egy újat
Spawner.Preset.Unsaved                  = az Aktuális mentése
Spawner.Preset.NewTooltip               = Create
Spawner.Preset.UpdateTooltip            = Frissítés
Spawner.Preset.RemoveTooltip            = Törlés
Spawner.Presets.NamePlaceholder         = Előre Beállított Név
Spawner.Presets.Name                    = Név
Spawner.Presets.NameError               = név hiba
Spawner.Preset.NotSelected              = előre beállított nincs kijelölve
