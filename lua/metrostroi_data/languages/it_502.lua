...
#######Buttons###########
#Common
Common.502.KS                   = Indicatore di funzionamento KSAUP 
Common.502.AV                   = L'autodrive è in funzione
Common.502.SD                   = SD: indicatore stato porte (le porte sono chiuse)
Common.502.SDW                  = SD: indicatore stato porte (le porte sono aperte)
Common.502.L3w                  = Terzo indicatore (modalità X3 )
Common.502.L4w                  = Quarto indicatore (direzione del movimento all'indietro)
Common.502.L5w                  = Quinto indicatore (direzione del movimento in avanti
Common.502.L16w                 = Sedicesimo indicatore (porte interbloccate)
Common.502.L20w                 = Ventesimo indicatore (LK2 e LK5 chiusura)
Common.502.L23w                 = Ventitresimo indicatore (Controllo del compressore)
Common.502.RK1                  = Controllo della prima posizione RK
Common.502.BRD                  = Indicatore guasto porte
Common.502.KOS                  = KB: Pulsante del limite di velocità (pulsante di attenzione)
Common.502.VAK                  = AK: Circuiti modalità d'emergenza 
Common.502.LRU                  = I circuiti di modalità di guida d'emergenza sono in funzione

#Spawner
Spawner.502.TypeNVL         = Treno da NVL
Spawner.502.TypeKVLO        = Veccio treno da KVL
Spawner.502.TypeKVLN        = Nuovo treno da KVL
Spawner.502.EWagons         = Aggiungi carri di tipo "E"

#gmod_subway_81-502
Entities.gmod_subway_81-502.Buttons.VBA.VBAToggle = Accensione / spegnimento della batteria dell'autodrive

Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: Modalità di guida di emergenza
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: Disattivare il dispositivo di controllo pneumatico
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: Disabilitare il controllo dell'interblocco della porta
...
Entities.gmod_subway_81-502.Buttons.RCAV3.RCAV3Toggle           = KSAUP sezionatore di circuiti (AV3)
Entities.gmod_subway_81-502.Buttons.RCAV4.RCAV4Toggle           = KSAUP sezionatore di circuiti (AV4)
Entities.gmod_subway_81-502.Buttons.RCAV5.RCAV5Toggle           = KSAUP sezionatore di circuiti (AV5)
